...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/devilmusicop/devilxangle)
...
```sh
git clone https://github.com/devilmusicop/devilxangle
cd VCPlayerBot
