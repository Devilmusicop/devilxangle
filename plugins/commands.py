...
async def start(client, message):
    ...
    buttons = [
        [
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/electro_updates'),
            InlineKeyboardButton('🧩 Source', url='https://github.com/devilmusicop/devilxangle')
        ],
        [
...
async def show_help(client, message):
    ...
    Config.msg['help'] = await message.reply_text(
        "Learn to use the devilVCPlayer, Showing help menu, Choose from the below options.",
        reply_markup=reply_markup,
        disable_web_page_preview=True
        )
...
async def repo_(client, message):
    buttons = [
        [
            InlineKeyboardButton('🧩 Repository', url='https://github.com/devilmusicop/devilxangle'),
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/elactro_updates'),     
        ],
        [
    ...
    await message.reply("<b>The source code of this bot is private and can be found at <a href=https://github.com/devilmusicop/devilxangle>devilxangle use in your group.\n\nFeel free to star☀️ the repo if you liked it 🙃.</b>", reply_markup=InlineKeyboardMarkup(buttons), disable_web_page_preview=True)
    await delete_messages([message])
